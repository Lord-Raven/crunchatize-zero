...
const DEFAULT_OUTCOME_TEMPLATE = '<div style="--show-true: flex; --show-false: none; --failure: 255, 0, 0; --mixed: 255, 140, 0; --success: 60, 179, 113; --critical: 176, 224, 230; --none: 153, 153, 153; margin: 1rem; ' +
    ...
    'font-family: system-ui, sans-serif; text-shadow: 2px 2px 4px #0003; font-size: 2rem; line-height: 2rem; white-space: pre;">' +
    '<div style="display: flex; justify-content: center; color: #ddd; font-size: 1.5rem;"><b><i>{{content}}</b></i></div>' +
    ...
    '<span style="color: rgb(var(--{{modifier_class}}));"> {{modifier_sign}} {{modifier_absolute}}</span><sup style="color: rgb(var(--{{modifier_class}}));"><sub><sup>(difficulty)</sup></sub></sup>' +
